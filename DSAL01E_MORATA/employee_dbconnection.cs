...
namespace DSAL01E_MORATA
{
    public class employee_dbconnection
    {
        ...
        public void employee_connString()
        {
            ...
            //employee_connectionString = @"Data Source = C203-24; Initial Catalog = SampleDatabaseDb; user id = SA; password = B1Admin123@";
            employee_connectionString = @"Data Source=DESKTOP-4B2S90A\SQLEXPRESS;Initial Catalog=POSDB;Integrated Security=True;";
