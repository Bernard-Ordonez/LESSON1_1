...
{
    public partial class Lesson14_Activity5 : Form
    {
        payroll_dbconnection payroll_db_connect = new payroll_dbconnection();
        payroll_variables pay_variables = new payroll_variables();
        ...
        private void previewPayslip_button_Click(object sender, EventArgs e)
        {
            ...
            payslip_viewListBox.Items.Add("Pay Date: " + " " + paydate_textBox.Text);
            payslip_viewListBox.Items.Add("------------------------------------------------------------");
        ...
        {
            payroll_db_connect.payroll_sql = "SELECT pos_empRegTbl.emp_id, emp_fname, emp_mname, emp_surname, emp_status, position, emp_no_of_dependents, emp_work_status, emp_department, picpath, basic_rate_hr, basic_no_of_hrs_cutOff, basic_income_per_cutOff, honorarium_rate_hr, honorarium_no_of_hrs_cutOff, honorarium_income_per_cutOff, other_rate_hr, other_no_of_hrs_cutOff, other_income_per_cutOff, sss_contrib, philhealth_contrib, pagibig_contrib, tax_contrib, sss_loan, pagibig_loan, fac_savings_deposit, fac_savings_loan, salary_loan, other_loans, total_deductions, gross_income, net_income, payrolltbl.emp_id, pay_date FROM pos_empRegTbl INNER JOIN payrollTbl ON pos_empRegTbl.emp_id = payrollTbl.emp_id WHERE (payrollTbl.emp_id = '" + empNum_textBox.Text + "' AND payrollTbl.pay_date ='" + paydate_textBox.Text + "')";

            payroll_db_connect.payroll_cmd();
            payroll_db_connect.payroll_sqladapterSelect();
            payroll_db_connect.payroll_sqldatasetSELECT();

            firstname_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][1].ToString();
            middleName_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][2].ToString();
            surname_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][3].ToString();
            civilStat_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][4].ToString();
            desig_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][5].ToString();
            numDep_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][6].ToString();
            empStat_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][7].ToString();
            dept_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][8].ToString();
            picPath_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][9].ToString();
            pictureBox1.Image = Image.FromFile(picPath_textBox.Text);

            rateHour_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][10].ToString();
            numHours_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][11].ToString();
            incomePerCut_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][12].ToString();

            rateHour_textBox2.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][13].ToString();
            numHours_textBox2.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][14].ToString();
            incomePerCut_textBox2.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][15].ToString();

            rateHour_textBox3.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][16].ToString();
            numHours_textBox3.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][17].ToString();
            incomePerCut_textBox3.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][18].ToString();

            sssCont_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][19].ToString();
            phCont_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][20].ToString(); pagibigCont_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][21].ToString();
            tax_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][22].ToString();
            
            sssLoan_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][23].ToString();
            pagibigLoan_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][24].ToString();
            facSavingsDep_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][25].ToString();
            facSavingsLoan_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][26].ToString();
            salaryLoan_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][27].ToString();
            others_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][28].ToString();
            totalDeduc_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][29].ToString();
            grossIncome_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][30].ToString();
            netIncome_textBox.Text = payroll_db_connect.payroll_sql_dataset.Tables[0].Rows[0][31].ToString();
        }

        private void search_button_Click(object sender, EventArgs e)
        {
            payroll_db_connect.payroll_sql = "SELECT emp_id, emp_fname, emp_mname, " +
            "emp_surname, emp_status, position, emp_no_of_dependents, " +
            "emp_work_status, emp_department, picpath FROM pos_empRegTbl WHERE " +
            "emp_id = '" + empNum_textBox.Text + "'";
        ...
        {
            payroll_db_connect.payroll_sql = "DELETE FROM payrolTbl WHERE emp_id = '" + empNum_textBox.Text + "'";
            payroll_db_connect.payroll_cmd();
        ...
        private void edit_button_Click(object sender, EventArgs e)
        {
            payroll_db_connect.payroll_sql = "UPDATE payrollTbl SET " +
                "basic_rate_hr = '" + rateHour_textBox.Text + "', " +
                "basic_no_of_hrs_cutOff = '" + numHours_textBox.Text + "', " +
                "basic_income_per_cutOff = '" + incomePerCut_textBox.Text + "', " +
                "honorarium_rate_hr = '" + rateHour_textBox2.Text + "', " +
                "honorarium_no_of_hrs_cutOff = '" + numHours_textBox2.Text + "', " +
                "honorarium_income_per_cutOff = '" + incomePerCut_textBox2.Text + "', " +
                "other_rate_hr = '" + rateHour_textBox3.Text + "', " +
                "other_no_of_hrs_cutOff = '" + numHours_textBox3.Text + "', " +
                "other_income_per_cutOff = '" + incomePerCut_textBox3.Text + "', " +
                "sss_contrib = '" + sssCont_textBox.Text + "', " +
                "philhealth_contrib = '" + phCont_textBox.Text + "', " +
                "pagibig_contrib = '" + pagibigCont_textBox.Text + "', " +
                "tax_contrib = '" + tax_textBox.Text + "', " +
                "sss_loan = '" + sssLoan_textBox.Text + "', " +
                "pagibig_loan = '" + pagibigLoan_textBox.Text + "', " +
                "fac_savings_deposit = '" + facSavingsDep_textBox.Text + "', " +
                "fac_savings_loan = '" + facSavingsLoan_textBox.Text + "', " +
                "salary_loan = '" + salaryLoan_textBox.Text + "', " +
                "other_loans = '" + others_textBox.Text + "', " +
                "total_deductions = '" + totalDeduc_textBox.Text + "', " +
                "gross_income = '" + grossIncome_textBox.Text + "', " +
                "net_income = '" + netIncome_textBox.Text + "', " +
                "pay_date = '" + paydate_textBox.Text + "' " +
                "WHERE emp_id = '" + empNum_textBox.Text + "' " +
                "AND pay_date = '" + paydate_textBox.Text + "'";
        ...
        private void Lesson14_Activity5_Load(object sender, EventArgs e)
        {
            //codes for disabling
        ...
        private void cleartextboxes()
        {
            ...
            facSavingsDep_textBox.Clear();
            facSavingsLoan_textBox.Clear();
            others_comboBox.Text = "Select other loan!";
        ...
        {
            payroll_db_connect.payroll_sql = "INSERT INTO payrollTbl (basic_rate_hr, basic_no_of_hrs_cutOff, basic_income_per_cutOff, honorarium_rate_hr, honorarium_no_of_hrs_cutOff, " +
                    "honorarium_income_per_cutOff, other_rate_hr, other_no_of_hrs_cutOff, other_income_per_cutOff, sss_contrib, philhealth_contrib, pagibig_contrib, tax_contrib, sss_loan, " +
                    "pagibig_loan, fac_savings_deposit, fac_savings_loan, salary_loan, other_loans, total_deductions, gross_income, net_income, emp_id, pay_date) " +
                    "VALUES('" + rateHour_textBox.Text + "', '" + numHours_textBox.Text + "', '" + incomePerCut_textBox.Text + "', '" + rateHour_textBox2.Text + "', '" +
                    numHours_textBox2.Text + "', '" + incomePerCut_textBox2.Text + "', '" + rateHour_textBox3.Text + "', '" + numHours_textBox3.Text + "', '" +
                    incomePerCut_textBox3.Text + "', '" + sssCont_textBox.Text + "', '" + phCont_textBox.Text + "', '" + pagibigCont_textBox.Text + "', '" +
                    tax_textBox.Text + "', '" + sssLoan_textBox.Text + "', '" + pagibigLoan_textBox.Text + "', '" + facSavingsDep_textBox.Text + "', '" + facSavingsLoan_textBox.Text + "', '" +
                    salaryLoan_textBox.Text + "', '" + others_textBox.Text + "', '" + totalDeduc_textBox.Text + "', '" + grossIncome_textBox.Text + "', '" + netIncome_textBox.Text + "', '" +
                    empNum_textBox.Text + "', '" + paydate_textBox.Text + "')";
