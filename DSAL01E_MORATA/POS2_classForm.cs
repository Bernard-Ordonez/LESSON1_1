...
namespace DSAL01E_MORATA
{
    public partial class POS2_classForm : Form
    {
        ...
        {
            price_textBox.Text = (price_item_value.GetPriceItem());
            discount_textBox.Text = (price_item_value.GetDiscountAmount());
        ...
        private void print_button_Click(object sender, EventArgs e)
        {
            ...
            POS2_classForm_PrintForm print = new POS2_classForm_PrintForm();
        ...
        {
            //calling the function with assigned value to item name and price inside the parameters
